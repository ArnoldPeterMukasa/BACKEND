# Generated by Django 5.0.1 on 2025-04-10 16:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'student'), ('lecturer', 'Lecturer'), ('registrar', 'Academic Registrar')], max_length=20)),
                ...
                ('lecturer_id', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='issue_tracker.issue')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('issue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='issue_tracker.issue')),
